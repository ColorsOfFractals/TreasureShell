...
function Find-ISCC {
    ...
    # 2. Ask Windows where Inno Setup is registered
    $RegistryRoots = @(
    ...
    foreach ($RegistryRoot in $RegistryRoots) {
        ...
        $Entries = Get-ChildItem $RegistryRoot -ErrorAction SilentlyContinue |
...
# Verify the discovered executable is actually the Inno compiler.
$PreviousErrorActionPreference = $ErrorActionPreference
$ErrorActionPreference = "Continue"
